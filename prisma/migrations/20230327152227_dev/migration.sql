...
CREATE TABLE "new_Domain" (
    ...
    CONSTRAINT "Domain_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "Devuser" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Devuser_username_key" ON "Devuser"("username");
